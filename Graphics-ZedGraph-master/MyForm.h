...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_h->Text = L"Начальный шаг";
			// 
			// textBox_h
			// 
			...
			this->label_N_max->Text = L"Максимальное число шагов";
			// 
			// textBox_x_0
			// 
			...
			this->label_epsilon->Text = L"Параметр контроля локальной погрешности";
			// 
			// textBox_z_0
			// 
			...
			this->label6->Text = L"Параметр выхода на правую границу";
			// 
			// label7
			// 
			...
			this->label12->Text = L"Максимум ||ОЛП||";
			// 
			// label13
			// 
			...
			this->label13->Text = L"Максимальный шаг";
			// 
			// label14
			// 
			...
			this->label14->Text = L"Увеличение шага ";
			// 
			// label15
			// 
			...
			this->label15->Text = L"Уменьшение шага";
			// 
			// label16
			// 
			...
			this->label16->Text = L"Результаты";
			// 
			// i
			// 
